...
$ docker run -itd --name chatgpt -p 8090:8090 \
  ...
  -e ALLOW_GROUPS=a,b -e ALLOW_USERS=a,b -e VIP_USERS=a,b -e ADMIN_USERS=a,b -e APP_SECRETS="xxx,yyy" \
...
- `📢 注意：`ALLOW_GROUPS,ALLOW_USERS,VIP_USERS,ADMIN_USERS四个参数为数组，如果需要指定多个，可用英文逗号分割。
